        ...
        try {
            try {
                ...
                let arResearch = [
                    ...
                    ['Исследование уровня дельта аминолевулиновой кислоты в моче ',0],
                    ...
                    ['Рентгенография длинных трубчатых костей (фтор и его соединения) ',0],
                ...
                let arHarmfulFactor = [
                    ...
                    ['1.18.3', 'Серебро1* и его соединения', 0],
                    ...
                    ['1.20', 'Ртутьр и ее соединения: ртутьр; металлоорганические соединения (ртуть неорганические соединения и прочие); органические соединения ртути', 0],
                    ['1.21', [
                        arResearch[0]._id
                    ...
                    ['1.26', 'Платиновые металлы и их соединения: рутений, родий, палладийА, диАммоний дихлорпалладийА, осмий, иридий, платина, диАммоний гексахлорплатинатА', 0],
                    ['1.27', [
                        arResearch[2]._id,
                        arResearch[4]._id
                    ...
                    ['1.27.2', 'Свинца органические соединения: тетраэтилсвинец0,1,4- дигидрооксибензол свинец аддукт', []],
                    ['1.28', [
                        arResearch[0]._id,
                        arResearch[1]._id
                    ...
                    ['1.31', [
                        arResearch[2]._id], 'Сурьмар и ее соединения', []],
                    ...
                    ['1.34.1', 'Дихлорметанр (хлористый метилен), 1,2- дихлорэтан, тетрахлорметан (четыреххлористый углерод)1”, трихлорметан (хлороформ), хлорметанр (хлористый метил), бромэтан, трихлорэтан, трихлорэтен, 1 и 2- хлорбута-1,3-диен (хлоропрен)1”, тетрафторэтен (перфторизобутилен), 2- бром-1,1,1 -трифтор-2 хлорэтан (фторотан)р и другие', []],
                    ['1.34.2', 'Хлорэтенкр (винилхлорид)', []],
                    ['1.35', [
                        arResearch[0]._id,
                        arResearch[1]._id
                    ...
                    ['1.37.1', 'Бензол10” и его производные: (толуолр (метилбензол), ксилолр (диметилбензол), стирол (этенилбензол) и прочие), гидроксибензолр (фенол) и его производные, крезол в том числе:', []],
                    ...
                    ['3.1', 'Аэрозоли преимущественно фиброгенногоф и смешанного типа действия, включая:', []],
                    ['3.1.1', [
                        arResearch[0]._id,
                        arResearch[1]._id
                    ...
                    ['20', 'Работы по оказанию медицинской помощи внутри барокамеры при проведении лечебной рекомпресии или гипербарической оксигенации', []],
                    ['21', [
                        arResearch[0]._id
                    ...
                    ['22', 'Работы, при выполнении которых разрешено ношение оружия и его применение (в случаях, когда требования о прохождении медицинских осмотров (освидетельствований) не установлены статьями 12 и 13 Федерального закона от 13 декабря 1996 г. № 150- ФЗ «Об оружии» и (или) профильным (специальным) законом)', []],
